...
class CityController extends Controller
{
    ...
    /**
     * Json all city entities.
     *
     * @Route("/json", name="city_json")
     * @Method({"GET", "POST"})
     */
    public function jsonAction()
    {
        $countries = $this->get('doctrine')->getRepository('AppBundle:City')->findAll();
        $response = array();
    ...
    /**
     * Json1 all city entities of a country.
     *
     * @Route("/json1", name="city_json1")
     * @Method({"GET", "POST"})
     */
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('city_show', array('idcity' => $city->getIdcity()));
        }
     ...
     *
     * @Route("/{idcity}/edit", name="city_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, City $city)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('city_edit', array('idcity' => $city->getIdcity()));
        }
    ...
    private function createDeleteForm(City $city)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('city_delete', array('idcity' => $city->getIdcity())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
