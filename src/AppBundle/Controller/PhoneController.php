...
class PhoneController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('phone_show', array('idphone' => $phone->getIdphone()));
        }
     ...
     *
     * @Route("/{idphone}/edit", name="phone_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Phone $phone)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('phone_edit', array('idphone' => $phone->getIdphone()));
        }
     ...
     *
     * @Route("/{idphone}", name="phone_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Phone $phone)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('phone_delete', array('idphone' => $phone->getIdphone())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
