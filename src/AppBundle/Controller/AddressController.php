...
class AddressController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('address_show', array('idaddress' => $address->getIdaddress()));
        }
     ...
     *
     * @Route("/{idaddress}", name="address_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{idaddress}/edit", name="address_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Address $address)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('address_edit', array('idaddress' => $address->getIdaddress()));
        }
     ...
     *
     * @Route("/{idaddress}", name="address_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Address $address)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('address_delete', array('idaddress' => $address->getIdaddress())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
